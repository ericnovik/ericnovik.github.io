...
There will be six homework assignments, an analysis project that can be completed in groups of up to three people, and two or three short in-class quizzes. All assignments must be completed in [R Markdown](https://rmarkdown.rstudio.com/lesson-1.html), [Quarto](https://quarto.org/docs/get-started/hello/rstudio.html), or similar systems suitable for scientific publication. During the final, each team will present the analysis to the class. The presentation should not contain more than five slides and should not take more than 10 minutes. We will distribute the presentation template and some guidelines for the analysis during the first week of class.

-   Six homework assignments: 60%
-   Two or three quizzes: 30%
-   Group project and presentation: 10%

Each team must present their work to get full credit for the analysis project.
