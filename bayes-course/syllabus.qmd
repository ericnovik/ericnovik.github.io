...
-   **(2) Conjugate models: Beta-Binomial**
    ...
    To demonstrate the Bayesian machinery, we will go over a few simple models for which analytical solutions are available. In practice, we seldom use conjugate models, but they have pedagogical value, are very fast, and allow us to validate numerical methods.
