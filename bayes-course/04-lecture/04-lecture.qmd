...
author: "Eric Novik | Spring 2023 | Lecture 4"
format:
  revealjs: 
    theme: ../../custom.scss
    scrollable: true
...
## MHR for N Interations
```{r}
#| echo: true
#| code-line-numbers: "|2|3|4|5|6|8|9|11|12|18|19|20|"
...
## Compararing Samples to the True Posterior {.smaller}
...
- To show why the aldorithm works you need to show:
  ...
  (b) The stationary distribution is our target distribution $f\theta | y)$
...
```
- It can shown that the posterior predictive distribution will have the same mean as the posterior distrution and the variance as the sum of the posterior variance and data variance:
