...
Describe the statistical model. Use statistical notation to specify your likelihood and all the priors. Briefly explain why you have selected the a particular likelihood and prior(s). If you are not familiar with LaTeX, see the LaTeX section.
...
-   Having a consisten coding style is important. See [this](https://style.tidyverse.org/index.html), for example, particularly if you are using R's `tidyverse`. For Stan code, see [this](https://mc-stan.org/docs/stan-users-guide/stan-program-style-guide.html) section of the Stan User's Guide.
