...
# Real data: one click per light flash, collected by hand in the browser app.
raw <- read.csv("data/moon-drop.csv")
d <- data.frame(t = raw$t_obs_s, x = raw$x_m)
