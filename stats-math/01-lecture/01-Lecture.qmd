...
::: incremental
-   This course will help you to prepare for the **A3SR MS program** and other statistics programs by covering the minimal necessary foundation in **computing**, **math,** and **probability**.

-   After completing the course, you will be able to write small to medium-size R programs and perform simulations, plot and manipulate data, solve basic probability problems, and understand the concept of regression
:::
